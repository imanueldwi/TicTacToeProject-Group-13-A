...
public enum Seed {   // to save as "Seed.java"
    CROSS("X", "images/rlpmenyala144-ezgif.com-apng-to-gif-converter.gif"),   // displayName, imageFilename
    NOUGHT("O", "images/redrawlowpoly-ezgif.com-apng-to-gif-converter.gif"),
    NO_SEED(" ", null);
